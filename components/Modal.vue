...
<template>
   <div v-if="show" class="fixed inset-0 flex items-center justify-center z-50">
    ...
    <div class="relative bg-[#FAFAFA] flex flex-col md:flex-row shadow-md rounded-2xl mt-10 overflow-hidden max-w-7xl h-full  max-h-[90vh] sm:max-h-[80vh]">
    ...
    <div class="px-6">
      ...
      <div class="flex py-1 gap-2 items-center">
        <span v-html="icon_mundo(25,'black')"></span>
      ...
      <div class="flex py-1 gap-2 items-center">
        <span v-html="icon_tel(30,'black')"></span>
